...
func build(p) -> Dictionary:
	...
	return {
		...
		"readability": {
			...
			"critical_parts": {
				"walking_beam": {"minimum_visible_fraction": 0.14,
					"members": ["walking_beam", "walking_beam_front", "walking_beam_back",
						"walking_beam_depth_rib_00", "walking_beam_depth_rib_01",
						"walking_beam_depth_rib_02"],
					"views": [0.0, 45.0, 135.0, 180.0, 225.0, 315.0]},
				"horsehead": {"minimum_visible_fraction": 0.10,
					"members": ["horsehead", "horsehead_face", "horsehead_back"]},
